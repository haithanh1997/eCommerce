...
namespace eCommerce.Static
{
    public static class Payment
    {
        ...
        public static string RepaidPaymentApi(string transactionId, decimal totalAmount = 0)
        {
            try
            {
                //Test PAYMENT
                ...
                //DITMELOZTHANHMICODE123PAY1000000127.0.0.1Uhttps://google.comhttps://google.comhttps://google.comMIPASSCODEMIKEY
                var cancelUrl = "http://localhost:58107/Admin/Statistic/CreateRePaid";               //Cancel payment
                var redirectUrl = "http://localhost:58107/Admin/Statistic/CreateRePaid";             //Redirect page
                var errorUrl = "http://localhost:58107/Admin/Statistic/CreateRePaid";                //Error payment
                var payment = new PaymentRequestModel()
                {
                    mTransactionID = transactionId,
                    merchantCode = "MICODE",
